...
test.describe("Finance ERP foundation", () => {
  test("login and open chart of accounts + journals", async ({ page }) => {
    ...
    await expect(page.getByText(/No hard-coded IDs/i)).toBeVisible();
