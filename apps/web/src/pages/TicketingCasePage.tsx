...
export default function TicketingCasePage() {
  ...
  if (!app) {
    return (
      <div className="p-5">
        ...
        <Link to="/ticketing" className="text-[11px] text-[var(--accent)] font-semibold">
          ← Air ticketing
        </Link>
      </div>
    );
  ...
  if (app.serviceType !== "air_ticket") {
    return (
      <div className="p-5">
        <ErrorBanner message={`This case is serviceType=${app.serviceType}, not air_ticket.`} />
        <Link to="/ticketing" className="text-[11px] text-[var(--accent)] font-semibold">
          ← Air ticketing
        </Link>
      </div>
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        subtitle={`${app.customer?.fullName || "Customer"} · ${app.title || "Air ticket"} · stage ${app.currentStage}/${app.totalStages}`}
        breadcrumb={[{ label: "Air ticketing", to: "/ticketing" }, { label: app.referenceNo }]}
        actions={
      ...
      <SuccessBanner message={ok} />
          ...
          <div className="mt-4 flex flex-wrap gap-2 items-end">
            <div className="flex-1 min-w-[200px]">
              <input
                ...
                placeholder="Note / consolidator ref…"
        ...
        <CaseFinanceCard
          ...
          setError={setError}
          setOk={setOk}
          defaultDescription={`${app.title || "Air ticket"} — ticket fee`}
        />
