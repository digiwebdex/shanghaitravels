...
import { Map, Plus, RefreshCw, Search } from "lucide-react";
  ...
  const columns: Column<Application>[] = [
    {
      ...
      header: "Reference",
      render: (a) => (
        <Link to={`/tours/${a.id}`} className="font-mono text-[11.5px] font-bold text-[var(--accent)] hover:underline">
          {a.referenceNo}
        </Link>
      ),
    },
      ...
      actions={
        <>
          ...
          <Can perm="application:create">
            <Link to="/tours/new" className={btnPrimary} style={btnPrimaryStyle}>
