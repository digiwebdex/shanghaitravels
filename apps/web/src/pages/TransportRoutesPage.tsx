        ...
        <Can perm="settings:manage">
          ...
          >
            <div className="sm:col-span-2">
              <p className="text-[10px] font-bold text-[var(--muted-foreground)] uppercase mb-1">Add route</p>
            </div>
            <div>
                ...
                <tbody>
                  {rows.map((r) => (
                    <tr key={r.id} className="border-b border-[var(--border)] text-[11px]">
                      <td className="px-4 py-2.5 font-semibold text-[var(--primary)]">{r.name}</td>
                      <td className="px-4 py-2.5 text-[var(--muted-foreground)]">
                        {SERVICE_KIND_LABELS[r.kind as keyof typeof SERVICE_KIND_LABELS] || r.kind}
                      </td>
                      <td className="px-4 py-2.5 text-[var(--muted-foreground)]">{r.origin}</td>
                      <td className="px-4 py-2.5 text-[var(--muted-foreground)]">{r.destination}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
