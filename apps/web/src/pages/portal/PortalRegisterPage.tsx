...
export default function PortalRegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--background)] p-4">
      <form onSubmit={onSubmit} className="w-full max-w-md bg-white border border-[var(--border)] rounded-xl p-5 space-y-3">
        ...
        <Link className="text-[11px] text-[var(--accent)] underline" to="/portal/customer/login">Back to login</Link>
      </form>
    </div>
  );
}
