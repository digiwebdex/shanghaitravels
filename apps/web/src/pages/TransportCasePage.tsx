...
import { TransportDetailCard } from "@/components/cases/TransportDetailCard";
import { TransportOpsCard } from "@/components/cases/TransportOpsCard";
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        subtitle={`${app.customer?.fullName || "Customer"} · ${app.title || "Transport"} · stage ${app.currentStage}/${app.totalStages}`}
        breadcrumb={[{ label: "Transport", to: "/transport" }, { label: app.referenceNo }]}
        actions={
